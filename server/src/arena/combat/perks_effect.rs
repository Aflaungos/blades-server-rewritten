...
fn augmented_flames_raises_a_fire_spell() {
    ...
    let perked = CasterPerks { perks: &bonuses, magicka_full: false, health_critical: false };
...
fn maximum_power_pays_only_at_full_magicka() {
    ...
    let full = CasterPerks { perks: &bonuses, magicka_full: true, health_critical: false };
    let ravaged = CasterPerks { perks: &bonuses, magicka_full: false, health_critical: false };
